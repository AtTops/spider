...
public class SqlUtils {
     ...
     *
     * @param dateStr 如果传入，则查找按日期处理评论标签，TODO
     * @return HashMap
     */
    public static HashMap<String, String> getSpuCodeAndTbLink(String... dateStr) {
        ...
        String sql;
        if (dateStr.length > 0) {
            sql = SqlEnum.SPU_TLINK_TIME.getDesc();
        } else {
            sql = SqlEnum.SPU_TLINK_SELL.getDesc();
        }
